    ...
    render() {
        ...
        return (
            <div className="sidebar">
                ...
                <img src={logo} />
                <p style={{ color: 'black', fontWeight: 'bold' }} className="gmail"><a href="https://www.linkedin.com/in/gabriel-almeida-c0d3r/" rel="opener noreferrer" target="_blank" className="fa fa-envelope"></a> gabrielalmeid45898@gmail.com </p>
                ...
                <div className="flip-card-back">
                    <ul className="sidebar-nav">
                        ...
                        <li className="sidebar-nav-icons"> <a href="mailto:gabrielalmeid45898@gmail.com" rel="opener noreferrer" target="_blank" className="fa fas fa-envelope fa-lg"></a></li>
